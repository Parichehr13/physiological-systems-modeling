...
## Executive Summary
Exercise 08 contains two related simulations. Part I (`Exercise8.m`) models CO2 dynamics with ventilation decomposition but with control gains set to zero. Part II (`Exercise8_II_vent.m`) extends the model to include O2 dynamics and active chemoreflex gains for both central and peripheral components.
...
## Part I: CO2 Model Without Active Gain (`Exercise8.m`)
...
## Part II: CO2+O2 Model With Active Gains (`Exercise8_II_vent.m`)
...
## Conclusion
Exercise 08 successfully demonstrates baseline and feedback-regulated gas exchange behavior.
