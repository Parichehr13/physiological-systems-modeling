...
## Discussion
This exercise demonstrates the value of feedback in a hemorrhage scenario. Without control, pressures and output collapse toward a low-flow state. With control, the system still reflects blood loss, but the drop in arterial pressure and cardiac output is much less severe.
...
## Conclusion
Exercise 04 confirms that the added controller improves hemodynamic stability during hemorrhage.
