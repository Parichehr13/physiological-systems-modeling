<<<<<<<< HEAD:08_gas_exchange_ventilation_control/gas_exchange_part1_co2.m
﻿    clear all
========
    clear all
>>>>>>>> 7c2f5a5 (Merge respiratory modules into a single project):respiratory_mechanics_gas_exchange/gas_exchange_control/Exercise8.m
close all
clc
Vlung = 2.5;
VD = 0.03;
